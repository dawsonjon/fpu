...
def compile():
    subprocess.call("iverilog -o test_bench_tb file_reader_a.v file_writer.v float_to_int.v test_bench.v test_bench_tb.v", shell=True)
...
#regression tests
stimulus_a = [0x2f005329, 0x34082401, 0xba57711a, 0xbf9b1e94, 0x5e8ef81, 0x5c75da81, 0x2b017]
run_test(stimulus_a)
