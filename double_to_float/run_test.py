...
def compile():
    subprocess.call("iverilog -o test_bench_tb file_reader_a.v file_writer.v double_to_float.v test_bench.v test_bench_tb.v", shell=True)
